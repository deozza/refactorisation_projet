...
class UserController extends AbstractController
{
    ...
    #[Route('/user/{identifiant}', name: 'udpate_user_by_id', methods:['PATCH'])]
    public function updateUserById(EntityManagerInterface $entityManager, $identifiant, Request $request): JsonResponse
    {
        $player = $entityManager->getRepository(User::class)->findBy(['id'=>$identifiant]);
