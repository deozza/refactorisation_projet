...
{
    #[Route('/users', name: 'get_list_users', methods:['GET'])]
    ...
    #[Route('/user/{identifiant}', name: 'get_user_id', methods:['GET'])]
    public function getUserId($identifiant, EntityManagerInterface $entityManager): JsonResponse
    {
    ...
    #[Route('/user/{identifiant}', name: 'udpate_user_id', methods:['PATCH'])]
    public function updateUserId(EntityManagerInterface $entityManager, $identifiant, Request $request): JsonResponse
    {
        $player = $entityManager->getRepository(User::class)->findBy(['id'=>$identifiant]);
    ...
    #[Route('/user/{id}', name: 'delete_user_id', methods:['DELETE'])]
    public function deleteUserId($id, EntityManagerInterface $entityManager): JsonResponse | null
    {
